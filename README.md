...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/leonbartlett/oh-my-zsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget -O- https://raw.githubusercontent.com/leonbartlett/oh-my-zsh/master/tools/install.sh)"
```
